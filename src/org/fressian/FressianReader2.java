...
public class FressianReader2 implements Reader, Closeable {
    private final InputSpi is;
    ...
    public FressianReader2(InputSpi is) {
        this(is, null);
    }

    public FressianReader2(InputSpi is, ILookup<Object, ReadHandler> handlerLookup) {
